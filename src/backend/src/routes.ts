...
import { loginHandler, logoutHandler, verifyOtp, otpPreferenceHandler, generateOtp, refreshAccessHandler, generateQRCode, getTokenStatus, googleAuthCallbackHandler } from './controllers/auth.controller';
